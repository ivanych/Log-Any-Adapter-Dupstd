...
Log::Any::Adapter::Duperr - The great new Log::Any::Adapter::Duperr!
...
Perhaps a little code snippet.
    ...
    my $foo = Log::Any::Adapter::Duperr->new();
    ...
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Log::Any::Adapter::Duperr
...
1; # End of Log::Any::Adapter::Duperr
